...
class UnnamedFN_VirtualFunctions
{
public:
	virtual void RegisterInitCallbacks(void* clbk0, void* clbk1, void* p_g_hUnnamedFN) = 0;
...
class UnnamedFN_Interface : public UnnamedFN_VirtualFunctions
{
public:
	void RegisterInitCallbacks(void* clbk0, void* clbk1, void* p_g_hUnnamedFN)
	{
...
{
	return (new UnnamedFN_Interface);
}
